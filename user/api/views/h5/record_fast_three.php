...
<div data-role="tabs" id="tabs">
    <div data-role="navbar">
        <div data-role="header" data-position="fixed" data-tap-toggle="false" class="tab-list-content">
            <ul>
                <li><a href="#one" class="ui-btn-active" onclick="selectFun(0)" data-transition="slide">百</a></li>
                <li><a href="#two" onclick="selectFun(1)" data-transition="slide">十</a></li>
                <li><a href="#three" onclick="selectFun(2)" data-transition="slide">个</a></li>
            </ul>
        </div>
