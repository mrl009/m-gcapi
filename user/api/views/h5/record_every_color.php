...
<div data-role="tabs" id="tabs">
    <div data-role="navbar">
        <div data-role="header" data-position="fixed" data-tap-toggle="false" class="tab-list-content">
            <ul>
                <li><a href="#one" class="ui-btn-active" onclick="selectFun(0)">万</a></li>
                <li><a href="#two" onclick="selectFun(1)">千</a></li>
                <li><a href="#three" onclick="selectFun(2)">百</a></li>
                <li><a href="#four" onclick="selectFun(3)">十</a></li>
                <li><a href="#five" onclick="selectFun(4)">个</a></li>
            </ul>
        </div>
