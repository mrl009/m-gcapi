...
class Yiliantong extends Publicpay
{
    //redis错误标识名称
    protected $r_name = 'YILIANTONG';
    //商户处理后通知第三方接口响应信息
    protected $success = '{retCode:"success"}'; //成功响应
    //异步返回必需验证参数
    protected $sf = 'sign'; //签名参数
    protected $of = 'platOrderId'; //订单号参数
    protected $mf = 'orderAmt'; //订单金额参数(实际支付金额)
    protected $vm = 1;//是否验证金额(部分第三方实际支付金额不一致)
    protected $vt = 'fen';//金额单位
    protected $tf = 'tradeState'; //支付状态参数字段名
