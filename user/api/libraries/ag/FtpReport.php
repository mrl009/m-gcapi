...
class FtpReport
{
     ...
     * 获取订单
     */
    public function get_bet_order($g_type)
    {
        $game_type = empty($g_type) ? ['AGIN', 'HUNTER', 'XIN', 'YOPLAY'] : $g_type;
    ...
    public function read_file($file_path)
    {
        ...
        if ($file) {
            ...
            while (@!feof($file)) {
                ...
                $this->ci->game_order->insert_order($data,$all_users);
            }
        }
    }
}
