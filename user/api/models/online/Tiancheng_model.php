...
class Tiancheng_model extends Publicpay_model
{
    protected $c_name = 'tiancheng';
    private $p_name = 'TIANCHENG';//商品名称
    ...
    protected function getPayUrl($pay)
    {
        ...
        {
            $pay_url = 'https://api.youqian668.com/gateway/api/h5apipay';
        } elseif (7 == $this->code) {
            $pay_url = 'https://pay.youqian668.com/gateway?input_charset=UTF-8';
        } elseif (in_array($this->code,$this->scan_code)) {
            $pay_url = 'https://api.youqian668.com/gateway/api/scanpay';
        }
        return $pay_url;
    }
