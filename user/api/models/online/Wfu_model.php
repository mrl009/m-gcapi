 ...
 */
class Wfu_model extends MY_Model
{
    public $privateKey;
    public $serviceKey;
    public $merId;
    ...
    public function call_interface($order_num, $money, $pay_data)
    {
        ...
        $this->callback = $this->domain . '/index.php/callback/Wfu/callbackurl';//回调地址
        // 组装数据
    ...
    private function getUrl($code)
    {
        if (in_array($code, [1, 4, 8, 9, 17])) {
            ...
            return 'https://api.5wpay.net/gateway/api/h5apipay';
        } else if ($code == 7) {
            return 'https://pay.5wpay.net/gateway?input_charset=UTF-8';
        }
    }
