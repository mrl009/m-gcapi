 ...
 * Time: 15:02
 */
class Kacheng_model extends MY_Model
{
    ...
    public function call_interface($order_num, $money, $pay_data)
    {
        ...
        $callbackurl = $pay_data['pay_domain'].'/index.php/callback/renxin/callbackurl';
        $hrefbackurl = $pay_data['pay_domain'].'/index.php/callback/renxin/hrefbackurl';
        ...
        $str  = "partner={$partner}&banktype={$banktype}&paymoney={$money}&ordernumber={$ordernumber}&callbackurl={$callbackurl}$tokenKey";
        ...
        if ($pay_data['code'] == 2 || $pay_data['code'] == 5 || $pay_data['code'] == 12) {
            $data['jump'] = 5;
        }
