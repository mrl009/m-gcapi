...
class Shoukjl_model extends Publicpay_model
{
    protected $c_name = 'shoukjl';
    protected $p_name = 'SHOUKJL';
    //支付接口签名参数
    ...
    {
        //传递参数
        $pay_data = json_encode($pay_data,JSON_UNESCAPED_SLASHES);
    ...
    {
        $sign = strtolower(md5(data_value($data).$this->key));
        return $sign;
    }
}