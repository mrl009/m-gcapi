...
class Jintong_model extends Publicpay_model
{
    protected $c_name = 'jintong';
    protected $p_name = 'JINTONG';
    //支付接口签名参数
    ...
    {
        if(in_array($this->code,[1,4,8,9,10,16,17,19,21,22,24,33,36]))
        {
    ...
    private function getPayType()
    {
        switch ($this->code)
        {
            case 1:
                ...
                break;
            case 2:
                return '02';//微信WAP  1,5,7,8,17,18,25
                break;
            case 34:
                return '03';//微信公众号  5,7,8,17,18,25
                break;
            case 4:
                return '11';//支付宝扫码
                break;
