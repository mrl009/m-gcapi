...
class Yiifut0_model extends Publicpay_model
{
    ...
    private function getPayType()
    {
        switch ($this->code)
        {
            ...
            case 4:
                ...
                break; 
            case 5:
                return '20000203';//支付宝WAP
                break;
            case 7:
                return '50000103';//网银支付
                break;
            case 8:
                return '70000103';//QQ扫码
                break;
            case 9:
                return '80000103';//京东扫码
                break;
            case 12:
                return '70000203';//QQWAP
                break;
            case 13:
                return '80000203';//京东WAP
                break;
            case 17:
                return '60000103';//银联扫码
                break;
            case 18:
                return '60000203';//银联WAP
                break;
            case 25:
                return '40000103';//网银快捷支付
                break;
            case 40:
                return '10000503';//微信条码
                break;
            case 41:
                return '20000503';//支付宝条码
                break;
            default:
                return '20000303';//支付宝扫码
                break;
